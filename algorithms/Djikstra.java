    ...
    public void calculateDistance(SwingWorker<Void, Void> worker, int curRow, int curCol) {
        try {
            if (!worker.isCancelled()) {
                ...
                // top neighbor
                if (!subtaskDone && curRow > 0 && gridArray[curRow][curCol].getBorder("top") == 0 && gridArray[curRow - 1][curCol].getVisited()) {
                ...
                // left neighbor
                if (!subtaskDone && curCol > 0 && gridArray[curRow][curCol].getBorder("left") == 0 && gridArray[curRow][curCol - 1].getVisited()) {
                ...
                // bottom neighbor
                if (!subtaskDone && curRow < gridArray.length - 1 && gridArray[curRow][curCol].getBorder("bottom") == 0 && gridArray[curRow + 1][curCol].getVisited()) {
                    map.put(new AbstractMap.SimpleEntry<Integer, Integer>(curRow + 1, curCol), curDistance + 1);
                    calculateDistance(worker, curRow + 1, curCol);
                }
                // right neighbor
                if (!subtaskDone && curCol < gridArray[0].length - 1 && gridArray[curRow][curCol].getBorder("right") == 0 && gridArray[curRow][curCol + 1].getVisited()) {
                    map.put(new AbstractMap.SimpleEntry<Integer, Integer>(curRow, curCol + 1), curDistance + 1);
                    calculateDistance(worker, curRow, curCol + 1);
                }    
            }
